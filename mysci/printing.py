def print_comparison(name, dates, times, original_data, computed_data):
   ...
   Parameters:
      ...
      datas: List of strings representing the dates for each data element
   ...
   for dates, times, orig, comp in zip_data:
      diff = orig - comp
      print(f'{dates} {times:>6} {orig:9.6f} {comp:9.6f} {diff:10.6f}')
